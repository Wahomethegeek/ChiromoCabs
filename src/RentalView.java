...
public class RentalView extends JFrame{
	...
	private JPanel mainP, reserveP, customerP, carP, finalP,employeeP; //panels for CardLayout
...
///////////////////////////////////////////////////// employee info//////////////////////////////////////
	private JLabel employeeL, eFirstNameL, eLastNameL, eGenderL, eContactL, eStatusL ; //inside the panel of customerPem
...
///////////////////////////////////////////////receipt/////////////////////////////////////
	...
	//---------------------------------------------------to go back welcome section
		ImageIcon EmployeeImage = new ImageIcon("./images/customer_back.GIF");
		...
		employeeB.setBackground(Color.CYAN);
		employeeB.setBounds(10, 300, 100, 50);
		employeeB.addActionListener(new employeeButton());
		employeeB.setActionCommand("GoToEmployee");
		reserveP.add(reserveBackB);
		//reserveP.add(employeeB);
		pane.add(reserveP, "reserveForm");

	//---------------------------------------------------to go to employee section
		...
		employeeB.addActionListener(new employeeNextButton());
	...
	///////////////////////////////////////////////////////last panel "recept" (finalP)/////////////////////////////////////
		...
		receiptA.setBounds(40, 30, 800, 800); //
		finalP.add(receiptA);
	...
	private class employeeNextButton implements ActionListener{
		public void actionPerformed(ActionEvent event) {
			...
			if(event.getActionCommand().equals("NextToPickEmployee")) {
	...
	private class finalStepButton implements ActionListener{
		public void actionPerformed(ActionEvent event) {
			...
			else { //if customer haven't yet pick a car, show's the warning information
